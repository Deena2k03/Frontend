...
const About = () => {
  const roles = [
    ...
    { title: "Quality Assurance (Q/A)", image: quality, desc: "Ensuring high standards of quality, compliance, and performance across all deliverables." },
      ...
      <div className="about-container">
        ...
        <div className="section-header">
          ...
          <p className="section-description">
            "A skilled team delivering healthcare, technology, and digital solutions
            built for performance, scalability, and long-term business growth."
          </p>
        </div>
